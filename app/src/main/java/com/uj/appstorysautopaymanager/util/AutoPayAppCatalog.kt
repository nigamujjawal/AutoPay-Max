...
val KnownAutoPayApps = listOf(
    ...
    AutoPayApp("YouTube Premium", "Y", Color(0xFFFF0000), R.drawable.ic_brand_youtube, listOf("youtube")),
    ...
    AutoPayApp("Vodafone Idea (Vi)", "VI", Color(0xFFEE2737), R.drawable.ic_brand_vodafone, listOf("vodafone")),
    ...
    AutoPayApp("WhatsApp", "W", Color(0xFF25D366), R.drawable.ic_brand_whatsapp, listOf("whatsapp")),
